...
#############Compile sources#############
vlog -work work "pll_test_tb.v"
vlog -work work "../pll_test.v"
vlog -work work "../ipcore/pll.v"

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs=+acc work.pll_test_tb
...
view signals
#add wave
add wave -radix hexadecimal pll_test_tb/dut/*
run 100000 ms
