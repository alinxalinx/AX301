...
wire                            sobel_de;
wire[7:0]                       sobel_out;
assign vga_out_hs = sobel_hs;
assign vga_out_vs = sobel_vs;
assign vga_out_r  = sobel_de == 1'b1 ? sobel_out[7:3] : 5'd0;
assign vga_out_g  = sobel_de == 1'b1 ? sobel_out[7:2] : 6'd0;
assign vga_out_b  = sobel_de == 1'b1 ? sobel_out[7:3] : 5'd0;
